...
import static com.github.autermann.wps.streaming.xml.EncodingTestHelper.createBoundingBox;
...
public class InputMessageEncodingTest {
    ...
    private InputMessage createMessage() throws XmlException {
        ...
        StreamingProcess.ID processId = StreamingProcess.ID.create();
        Message.ID ref = Message.ID.create();
        ...
        message.addRelatedMessages(RelationshipType.Needs, ref);
        return message;
    }
