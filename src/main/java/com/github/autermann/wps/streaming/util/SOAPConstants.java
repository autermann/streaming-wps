...
public final class SOAPConstants {
    ...
    public static String getRequestOutputAction() {
        return REQUEST_OUTPUT_ACTION.toString();
    }

    public static URI getRequestOutputActionURI() {
        return REQUEST_OUTPUT_ACTION;
    }

    public static String getStopAction() {
        return STOP_ACTION.toString();
    }
