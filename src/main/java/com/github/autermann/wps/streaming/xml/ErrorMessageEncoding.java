...
public class ErrorMessageEncoding extends AbstractMessageEncoding<ErrorMessage> {
    private static final String JAVA_ROOT_CAUSE_EXCEPTION_CODE
            = "JAVA_RootCause";
    private static final String JAVA_STACK_TRACE_EXCEPTION_CODE
            = "JAVA_StackTrace";
    ...
    protected XmlObject createBody(ErrorMessage message) throws XmlException {
        ...
        xbErrorMessage.addNewProcessID().setStringValue(message.getProcessID()
                .toString());
